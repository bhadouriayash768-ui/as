        ...
        <div className="hero__layout">
          <div className="hero__copy">
            ...
            <p className="hero__lead reveal-three">
              Syntha Airlabs builds clear, high-performing business websites and landing pages that help ambitious businesses look credible, reach more people, and move with confidence.
            </p>
        ...
        <div className="services-grid">
          {SERVICES.map((service, index) => (
            <article className={`service-card service-card--${index + 1}`} key={service.number}>
              ...
              <h3><a className="service-card__title-link" href={service.href}>{service.title}</a></h3>
              <p>{service.text}</p>
